...
quiz_questions = [
    ['Question No. 0: When did the WW1 start?', '1', ['28 july 1914', '28 june 1914', '28 july 1916', '28 june 1916'],'history'],
    ['Question No. 1: Who invented the first Vaccine', '2', ['Louis pasteur', 'Edward jener', 'Alexander Fleming', 'james Phipps'],'history'],
    ...
    ['Question No. 11: Positive Liberty is advocated by', '2', ['J.S.Mill', 'T.H.Green', 'Isiah Berlin', 'Locke'],'politics'],
    ['Question No. 12: Who wrote the book “Social Contract”?', '3', ['Thompson Mill', 'Mill', 'J.J Rousseau', 'John Locke'],'politics'],
    ['Question No. 13: Term “Historicism” was made popular by', '4', ['Foster', 'Sabine', 'Locke', 'Popper'],'politics'],
    ['Question No. 14: Who has described politics as” acting in concert”?', '5', ['Aristotle', 'Hannah Arendt', 'Aristole', 'Karl Marx'],'politics'],
    ['Question No. 15: Who is the father of Political Science?', '6', ['Karl Max', 'Plato', 'Aristotle', 'Austin'],'politics'],
    ['Question No. 16: Who called political Science as the Master Science?', '7', ['Cicero', 'Hobbes', 'Socrates', 'Aristotle'],'politics'],
    ['Question No. 17: Permanent Revolution was propounded by', '8', ['Trostky', 'Marx', 'Lenin', 'Engens'],'politics'],
    ['Question No. 18: "Physiocrats” were:', '9', ['Russian proletarians', 'French economist', 'German nazis', 'Dutch physicist'],'politics'],
    ['Question No. 19: Which of the following is the example of unwritten constitution?', '1', ['Saudi Arabia', 'England', 'Japan', 'France'],'politics'],
    ['Question No. 20: Who wrote the book “Republic”?', '2', ['Locke', 'Plato', 'Cicero', 'Bodin'],'politics'],
    ...
    ['Question No. 31:Who wrote the book “ Principles of Economics”?', '4', ['Pele', 'Carl Menger', 'Leon Walras', 'Alfred Marshall'],'economics'],
    ['Question No. 32:Who is known as the father of modern economics?', '5', ['David Ricardo', 'Adam Smith', 'W robert', 'Quesnay'],'economics'],
    ['Question No. 33:The critical minimum effort theory is due to', '6', ['D.Ricardo', 'W.A.Lewis', 'H.Liebenstein', 'Hirschman'],'economics'],
    ['Question No. 34:Who has given the theory of “Big Push”?', '7', ['Lewis', 'Harvey', 'Smith', 'P N. Rosentein-Rodan'],'economics'],
    ['Question No. 35:The IS-LM model was developed by', '8', ['John Hicks', 'J.Romer', 'Lucas', 'JP.hagen'],'economics'],
    ['Question No. 36:Relational Expectation Theory is associated with', '9', ['None of the above', 'Lucas', 'Hicks', 'Romer'],'economics'],
    ['Question No. 37:“Money is what money does”. Who said this?', '6', ['Hagen', 'Roberto', 'Walker', 'Smith'],'economics'],
    ['Question No. 38:Lorenz curve enables one to study which of the following', '7', ['Average', 'Tax rates', 'Correlation', 'Dispersion'],'economics'],
    ['Question No. 39:Input-Output Technique was invented by', '8', ['Wassily Leontief', 'Romero', 'Robert Solo', 'Lucas'],'economics'],
    ['Question No. 40:At the break-even point, the total cost equals', '9', ['Total lost', 'Total Revenue', 'Total capital', 'Total profit'],'economics']
    ]
